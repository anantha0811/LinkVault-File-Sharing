      ...
      <Body style={main}>
        <Container>
          <Section style={content}>
            <Img width={620} src={`https://ibb.co/8BTg8Td`} />
            ...
            <Row style={{ paddingBottom: "0" }}>
              <Column>
                ...
                <Text style={paragraph}>
                  Now You can also share file with Anantha Krishnan B's
                  LinkVault App
                </Text>
                <Text style={{ marginTop: -5 }}>
          ...
          >
            © 2024 | Anantha Krishnan B @2024 Copyrights India |
            linkedin/anantha-krishnan0811/
          </Text>
        </Container>
      </Body>
    </Html>
